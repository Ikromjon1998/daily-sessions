...
def higher_card(card_one: str, card_two: str) -> str | tuple[str, str]:
    ...
    Returns:
        str or tuple: The resulting tuple contains both cards if they are
        of equal value.
    """
...
def is_blackjack(card_one: str, card_two: str) -> bool:
    ...
    """
    first = 11 if card_one == "A" else value_of_card(card_one)
    second = 11 if card_two == "A" else value_of_card(card_two)
